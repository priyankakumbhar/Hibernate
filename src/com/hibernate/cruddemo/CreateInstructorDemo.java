	...
	public static void main(String[] args) {
		...
		try
		{
			...
			*/
			//associate objects
			//create the object
			Instructor instructor=new Instructor("vivek","kulkarni","vivekkulkarni@gmail.com");
			
			InstructorDetails instructorDetails=new InstructorDetails("www.youtube.com/game","game player");
